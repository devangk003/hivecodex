          ...
          {codeContent.split('\n').map((line, index) => (
            <div key={index} className="flex">
              ...
              <div className="flex-1">
                {line.includes('from') && <span className="text-pink-400">from</span>}
                {line.includes('import') && <span className="text-pink-400"> import</span>}
                {line.includes('discord.ext') && <span className="text-green-400"> discord.ext</span>}
                {line.includes('commands') && <span className="text-blue-400"> commands</span>}
                ...
                {!line.includes('from') && !line.includes('bot') && !line.includes('@') && !line.includes('async') && !line.includes('await') && line.trim() && (
